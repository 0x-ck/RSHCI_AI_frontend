...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={handlesubmit} className="w-full flex flex-col">
            ...
            <input type="password" value={currentItem.password} onChange={e => dispatch(setCurrentItemValue({ password: e.target.value }))} className="w-full rounded-[5px] p-[10px] bg-[#c5c5c5] border-[#d1a2a2] text-[#111]"  placeholder="Password" />
